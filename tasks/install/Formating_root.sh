...
logCreate "Formatting /dev/mapper/vg0-root with Btrfs..."
...
logCreate "Mounting root volume to /mnt for subvolume creation..."
mount /dev/mapper/vg0-root /mnt
logSuccess "Mounted /dev/mapper/vg0-root to /mnt"

# Create Btrfs subvolumes
logCreate "Creating Btrfs subvolumes..."
...
logCreate "Mounting EFI system partition to /mnt/boot..."
